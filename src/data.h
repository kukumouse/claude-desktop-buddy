...
static void _applyJson(const char* line, TamaState* out) {
  ...
  if (!t.isNull() && t.size() == 2) {
    ...
    auto tm = m5::rtc_time_t{ (int8_t)lt.tm_hour, (int8_t)lt.tm_min, (int8_t)lt.tm_sec };
    auto dt = m5::rtc_date_t{ (int16_t)(lt.tm_year + 1900), (int8_t)(lt.tm_mon + 1), (int8_t)lt.tm_mday };
