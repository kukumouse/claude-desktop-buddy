...
// M5.Display for the landscape clock (both inherit TFT_eSPI).
...
// One-shot half-scale render to an arbitrary surface (M5.Display for the
...
void characterRenderTo(M5GFX* tgt, int cx, int cy) {
  ...
  M5GFX* prevT = _tgt; bool prevP = peekMode; int px = gifX, py = gifY;
