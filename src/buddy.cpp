...
// M5.Display for landscape clock mode (both inherit TFT_eSPI). Coords stay
...
// One-shot render to an arbitrary TFT_eSPI surface (M5.Display for landscape
...
void buddyRenderTo(M5GFX* tgt, uint8_t personaState) { 
